{{-- filepath: resources/views/admin/masters/packages/create.blade.php --}}
            ...
            <div class="col-12 d-flex justify-content-between align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 bg-transparent p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><b>Add Package</b></li>
                    </ol>
                </nav>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h5 class="mb-3 fw-bold">ADD PACKAGE</h5>
                        <hr>
                        <form action="{{ route('admin.packages.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="package_count" id="package_count" class="form-control" value="{{ old('package_count', 0) }}" required>
                                @error('package_count')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
