                ...
                <nav aria-label="breadcrumb">
                    <ol class="modern-breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            ...
                            <span class="breadcrumb-text">Packages</span>
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="compact-header-card">
                <div class="compact-header-content">
                    ...
                    <div class="compact-header-text">
                        <h1 class="compact-page-title">Packages Management</h1>
                        <p class="compact-page-subtitle">Manage all available packages for your platform</p>
                    </div>
                </div>
                <div class="compact-header-actions">
                    <a href="{{ route('admin.packages.create') }}" class="enterprise-btn btn-success">
                    ...
                    <table class="enterprise-data-table">
                        <thead class="table-header-section">
                            <tr>
                                ...
                                <th class="table-header-cell package-column">
                                    <div class="header-cell-content">
                                        <i class="bx bx-package header-icon"></i>
                                        <span>Package Name</span>
                                    </div>
                                </th>
                                <th class="table-header-cell count-column">
                                    <div class="header-cell-content">
                                        <i class="bx bx-list-ol header-icon"></i>
                                        <span>Count</span>
                                    </div>
                                </th>
                        ...
                        <tbody class="table-body-section">
                            @forelse($packages as $package)
                                <tr class="table-data-row package-row" data-package-id="{{ $package->id }}">
                                    <td class="table-data-cell no-cell">
                                        <div class="number-display">
                                            <span class="row-number">{{ $loop->iteration }}</span>
                                        </div>
                                    </td>
                                    <td class="table-data-cell package-cell">
                                    ...
                                    <td class="table-data-cell count-cell">
                                        <div class="count-display">
                                            <span class="count-number">{{ $package->package_count }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="table-data-cell actions-cell">
                                        <div class="action-buttons-group">
                                            ...
                                            <form action="{{ route('admin.packages.destroy', $package->id) }}"
                                                  ...
                                                  onsubmit="return confirmDelete('{{ $package->package_name }}')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                ...
                                <tr class="empty-state-row">
                                    <td colspan="5" class="empty-state-cell">
                                        <div class="professional-empty-state">
                                            <div class="empty-state-icon packages-empty-icon">
                                                <i class="bx bx-package"></i>
                                            </div>
                                            <h3 class="empty-state-title">No Packages Found</h3>
                                            <p class="empty-state-message">Start by adding your first package.</p>
                                            <a href="{{ route('admin.packages.create') }}" class="enterprise-btn btn-success">
                                                <i class="bx bx-plus"></i>
...
@push('styles')
<style>
/* Copy the CSS from your ranks index.blade.php and adjust for packages if needed */
:root {
...
.no-column { width: 8%; }
.package-column { width: 30%; }
.count-column { width: 15%; }
