        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Rank</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="border p-3 rounded">
                        <h6 class="mb-0 text-uppercase">Add Rank</h6>
                        <hr>
                        ...
                        <form action="{{ route('admin.ranks.store') }}" method="POST">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-success">Save Rank</button>
                            </div>
                        </form>
