...
class MobileCountryCodeSeeder extends Seeder
{
    ...
    {
        $data = [
            ["country_name" => "Afghanistan", "country_code" => "AF", "dial_code" => "+93"],
            ...
            ["country_name" => "American Samoa", "country_code" => "AS", "dial_code" => "+1-684"],
            ["country_name" => "Andorra", "country_code" => "AD", "dial_code" => "+376"],
            ["country_name" => "Angola", "country_code" => "AO", "dial_code" => "+244"],
            ["country_name" => "Anguilla", "country_code" => "AI", "dial_code" => "+1-264"],
            ["country_name" => "Antarctica", "country_code" => "AQ", "dial_code" => "+672"],
            ["country_name" => "Antigua and Barbuda", "country_code" => "AG", "dial_code" => "+1-268"],
            ...
            ["country_name" => "Bahamas", "country_code" => "BS", "dial_code" => "+1-242"],
            ["country_name" => "Bahrain", "country_code" => "BH", "dial_code" => "+973"],
            ["country_name" => "Bangladesh", "country_code" => "BD", "dial_code" => "+880"],
            ["country_name" => "Barbados", "country_code" => "BB", "dial_code" => "+1-246"],
            ...
            ["country_name" => "Bermuda", "country_code" => "BM", "dial_code" => "+1-441"],
            ...
            ["country_name" => "Bouvet Island", "country_code" => "BV", "dial_code" => "+47"],
            ...
            ["country_name" => "Cayman Islands", "country_code" => "KY", "dial_code" => "+1-345"],
            ...
            ["country_name" => "Cocos (Keeling) Islands", "country_code" => "CC", "dial_code" => "+61"],
            ...
            ["country_name" => "Congo (Democratic Republic)", "country_code" => "CD", "dial_code" => "+243"],
            ...
            ["country_name" => "Dominica", "country_code" => "DM", "dial_code" => "+1-767"],
            ["country_name" => "Dominican Republic", "country_code" => "DO", "dial_code" => "+1-809"],
            ...
            ["country_name" => "Eswatini", "country_code" => "SZ", "dial_code" => "+268"],
            ["country_name" => "Ethiopia", "country_code" => "ET", "dial_code" => "+251"],
            ["country_name" => "Falkland Islands", "country_code" => "FK", "dial_code" => "+500"],
            ...
            ["country_name" => "Grenada", "country_code" => "GD", "dial_code" => "+1-473"],
            ["country_name" => "Guadeloupe", "country_code" => "GP", "dial_code" => "+590"],
            ["country_name" => "Guam", "country_code" => "GU", "dial_code" => "+1-671"],
            ...
            ["country_name" => "Heard Island and McDonald Islands", "country_code" => "HM", "dial_code" => "+672"],
            ["country_name" => "Holy See", "country_code" => "VA", "dial_code" => "+39"],
            ...
            ["country_name" => "Iran", "country_code" => "IR", "dial_code" => "+98"],
            ...
            ["country_name" => "Jamaica", "country_code" => "JM", "dial_code" => "+1-876"],
            ...
            ["country_name" => "Korea (North)", "country_code" => "KP", "dial_code" => "+850"],
            ["country_name" => "Korea (South)", "country_code" => "KR", "dial_code" => "+82"],
            ["country_name" => "Kuwait", "country_code" => "KW", "dial_code" => "+965"],
            ["country_name" => "Kyrgyzstan", "country_code" => "KG", "dial_code" => "+996"],
            ["country_name" => "Laos", "country_code" => "LA", "dial_code" => "+856"],
            ...
            ["country_name" => "Libya", "country_code" => "LY", "dial_code" => "+218"],
            ...
            ["country_name" => "Micronesia", "country_code" => "FM", "dial_code" => "+691"],
            ["country_name" => "Moldova", "country_code" => "MD", "dial_code" => "+373"],
            ...
            ["country_name" => "Montserrat", "country_code" => "MS", "dial_code" => "+1-664"],
            ...
            ["country_name" => "North Macedonia", "country_code" => "MK", "dial_code" => "+389"],
            ["country_name" => "Northern Mariana Islands", "country_code" => "MP", "dial_code" => "+1-670"],
            ...
            ["country_name" => "Palestine", "country_code" => "PS", "dial_code" => "+970"],
            ...
            ["country_name" => "Pitcairn", "country_code" => "PN", "dial_code" => "+872"],
            ["country_name" => "Poland", "country_code" => "PL", "dial_code" => "+48"],
            ["country_name" => "Portugal", "country_code" => "PT", "dial_code" => "+351"],
            ["country_name" => "Puerto Rico", "country_code" => "PR", "dial_code" => "+1-787"],
            ...
            ["country_name" => "Russia", "country_code" => "RU", "dial_code" => "+7"],
            ...
            ["country_name" => "Saint Kitts and Nevis", "country_code" => "KN", "dial_code" => "+1-869"],
            ["country_name" => "Saint Lucia", "country_code" => "LC", "dial_code" => "+1-758"],
            ...
            ["country_name" => "Saint Vincent and the Grenadines", "country_code" => "VC", "dial_code" => "+1-784"],
            ["country_name" => "Samoa", "country_code" => "WS", "dial_code" => "+685"],
            ...
            ["country_name" => "Sint Maarten", "country_code" => "SX", "dial_code" => "+1-721"],
            ...
            ["country_name" => "South Georgia", "country_code" => "GS", "dial_code" => "+500"],
            ...
            ["country_name" => "Syria", "country_code" => "SY", "dial_code" => "+963"],
            ["country_name" => "Taiwan", "country_code" => "TW", "dial_code" => "+886"],
            ["country_name" => "Tajikistan", "country_code" => "TJ", "dial_code" => "+992"],
            ["country_name" => "Tanzania", "country_code" => "TZ", "dial_code" => "+255"],
            ...
            ["country_name" => "Trinidad and Tobago", "country_code" => "TT", "dial_code" => "+1-868"],
            ["country_name" => "Tunisia", "country_code" => "TN", "dial_code" => "+216"],
            ["country_name" => "Turkey", "country_code" => "TR", "dial_code" => "+90"],
            ["country_name" => "Turkmenistan", "country_code" => "TM", "dial_code" => "+993"],
            ["country_name" => "Turks and Caicos Islands", "country_code" => "TC", "dial_code" => "+1-649"],
            ...
            ["country_name" => "Vietnam", "country_code" => "VN", "dial_code" => "+84"],
            ["country_name" => "Virgin Islands (British)", "country_code" => "VG", "dial_code" => "+1-284"],
            ["country_name" => "Virgin Islands (U.S.)", "country_code" => "VI", "dial_code" => "+1-340"],
        ...
        DB::table('mobile_country_codes')->insert($data);
    }
}
